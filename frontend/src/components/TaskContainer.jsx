    ...
    return (
        <div className="task-container">
            ...
            { taskList.map( task => { return (
                <Task task={task} key={task._id} updateTaskList={fetchTasks}  updateCompletedTasks={fetchCompletedTasks}/>)
                })}
            
            <CompletedTasks updateTaskList={fetchTasks} completedTasks={completedTasks} fetchCompletedTasks={fetchCompletedTasks}/>
        </div>
    );
}